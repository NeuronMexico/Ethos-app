...
const icons = [
  ...
  { name: 'DeferIcon', component: <DeferIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'ClipIcon', component: <ClipIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'FaceIDIcon', component: <FaceIDIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'FlipIcon', component: <FlipIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'LensIcon', component: <LensIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'MessageDotsIcon', component: <MessageDotsIcon width={25} height={25} /> },
  { name: 'MicrophoneIcon', component: <MicrophoneIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'PinDropIcon', component: <PinDropIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'PinIcon', component: <PinIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'QuestionIcon', component: <QuestionIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'ScanIcon', component: <ScanIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'SendIcon', component: <SendIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'ShieldIcon', component: <ShieldIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  { name: 'TackIcon', component: <TackIcon width={25} height={25} color={Theme.Colors.Encore} /> },
  ...
  { name: 'TopicsIcon', component: <TopicsIcon width={25} height={25} color={Theme.Colors.Encore} /> },
