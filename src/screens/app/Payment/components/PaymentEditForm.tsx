...
const PaymentEditForm: React.FC<Props> = ({
  onSubmit = () => {},
}: Props) => {
  ...
  const [account, setAccount] = useState<string>('SANTANDER');
  ...
  return (
    <Container flex>
      <Picker
        ...
        marginLeft={24}
        value={account}
        caption="416931238912390"
        onValueChange={setAccount}
        labelWithValue
      />
      <Picker
        title="TDC ethoscrédito"
        label={t('transactions:whatCard')}
        options={[
