...
const WithdrawalNoCardScreen: React.FC<Props> = ({
  onPressCash,
  ...
  return (
    <Container flex>
      <Header title={t('personalDisposition:noCardWithdrawal')} showVirtualAssistantAction />
...
export default WithdrawalNoCardScreen;
